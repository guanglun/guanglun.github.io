...
## 到手使用  
1. 板子到手后请插入typec线缆上电，等待片刻后使用电脑连接WIFI：DRONE5G(使用5G频段是为了避免2.4G遥控器干扰，可以手动进入系统切换2.4G)  
...
5. 检查电机顺序和方向，当前仅支持PX4的X机架，其他没测试。电调请使用支持dshot300的电调，电机方向反向的话请交换线序，软件不支持反向电机  
6. 可以校准一下陀螺仪和水平  
7. 在未装桨情况下解锁测试功能是否正常  
8. 装桨小心测试飞行  
